	...
	public function store(Request $request){
		...
		if(is_object($params) && $params != null){
			...
			$validate = \Validator::make($params_array, [
				...
				'aseguradora'				=> 'nullable|numeric',
				'direccion'					=> 'nullable',
				'perfil'					=> 'nullable|numeric',
				'vinculacion'				=> 'required|numeric',
				'area'						=> 'nullable|numeric',
				'unidad' 					=> 'nullable|numeric',
				'fechaIngreso'				=> 'nullable',
				'fechaEgreso'				=> 'nullable',
				'fechaSintomas'				=> 'nullable',
				...
				'manejo'					=> 'nullable|numeric',
				'remitido'					=> 'nullable',
				'fechaTomaMuestra'			=> 'nullable',
				'fechaResultado'			=> 'nullable',
				'diasTranscurridos'			=> 'nullable',
				'contagiado'				=> 'required|numeric',
				'nexo'						=> 'required|numeric',
				'primerSeguimiento' 		=> 'nullable',
				'nombrePrimerSeguimiento'	=> 'nullable',
				'segundoSeguimiento'		=> 'nullable',
				'nombreSegundoSeguimiento'	=> 'nullable',
				'estado'					=> 'nullable|numeric',
				'trabajo'					=> 'nullable|numeric',
			...
			if($validate->fails()){
				...
				$data = array(
					'status'		=> 'success',
					'code'			=> 201,
					'message'		=> 'Se ha realizado correctamente un nuevo registro '.$collaborator->documento,
					'collaborator'	=> $collaborator
				);
			}
		} else {
